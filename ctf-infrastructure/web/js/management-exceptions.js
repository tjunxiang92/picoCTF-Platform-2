...
ExceptionTab = React.createClass({displayName: "ExceptionTab",
  ...
  createExceptionItem: function(exception, i) {
    var deleteButton, exceptionHeader, occurencesBadge, time;
    ...
    exceptionHeader = React.createElement("div", null, exception.request.api_endpoint_method, " ", React.createElement("b", null, exception.request.api_endpoint), React.createElement("div", {
