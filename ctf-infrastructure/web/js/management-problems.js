...
ProblemClassifierList = React.createClass({displayName: "ProblemClassifierList",
  render: function() {
    ...
    return React.createElement(PanelGroup, {
      ...
      "collapsible": true
    }, React.createElement(ProblemClassifier, React.__spread({
      "name": "State",
      "data": problemStateData
    }, this.props)), React.createElement(ProblemClassifier, React.__spread({
      "name": "Categories",
      "data": categoryData
    }, this.props)), React.createElement(ProblemClassifier, React.__spread({
      "name": "Organizations",
...
ProblemClassifier = React.createClass({displayName: "ProblemClassifier",
  ...
  render: function() {
    return React.createElement(Panel, {
      ...
      return React.createElement(ClassifierItem, React.__spread({
  ...
  render: function() {
    ...
    problemComponents = this.props.problems.map((function(problem, i) {
      return React.createElement(Col, {
        "xs": 12.
      }, React.createElement(Problem, React.__spread({
        "key": problem.name,
