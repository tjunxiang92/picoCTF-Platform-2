...
ServerForm = React.createClass({displayName: "ServerForm",
  ...
  render: function() {
    var buttons, hostDescription, passwordDescription, portDescription, protocolDescription, usernameDescription;
    ...
    return React.createElement("div", null, React.createElement(TextEntry, {
      "name": "Host",
      "type": "text",
...
ShellServerList = React.createClass({displayName: "ShellServerList",
  ...
  createShellServerForm: function(server, i) {
    ...
    if (server === null) {
      ...
      header = React.createElement("div", null, " ", server.host, " ");
    }
...
ShellServerTab = React.createClass({displayName: "ShellServerTab",
  render: function() {
    return React.createElement(Well, null, React.createElement(Grid, null, React.createElement(Row, null, React.createElement("h4", null, "To add problems, either enter your shell server information on the left or paste your published JSON on the right.")), React.createElement(Row, null, React.createElement(Col, {
      "md": 6.
    }, React.createElement(ShellServerList, null)), React.createElement(Col, {
      "md": 6.,
      "className": "pull-right"
    }, React.createElement(ProblemLoaderTab, null)))));
  }
});
